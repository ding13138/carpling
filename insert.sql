...
('20001', ' https://cdn.autoc-one.jp/images/article/202103/12153801205_2725_o.jpg ', 'Toyota', 'カムロード(リバティ 52DB)', 'Normal', 'Luxury', 'キャンピング', '14,350,000~' , '軽油', 5230 , 2040, 2880 , 3570 ,'AWD', 'トヨタが送る大型キャンピングカー。','これはダミーテキストです。'),
('20002', ' https://nutsrv.co.jp/images/lineup/border/index/top_slide01.jpg?202502051446 ', 'ナッツRV', 'ボーダーバンクス', 'Normal', 'Luxury', 'キャンピング', '17,149,000~18,029,000' , '軽油', 6255 , 2230, 3020 , 4740 ,'AWD', 'これはダミーテキストです。','これはダミーテキストです。'),
('20003', ' https://nutsrv.co.jp/images/lineup/aletta/index/top_slide01.jpg ', 'ナッツRV', 'アレッタ', 'Normal', 'Luxury', 'キャンピング', '9,500,000~11,673,000' , '軽油', 4850 , 1950, 2850 , 3000 ,'AWD', 'これはダミーテキストです。','これはダミーテキストです。'),
('20004', ' https://nutsrv.co.jp/images/lineup/cresson/index/top_slide01.jpg ', 'ナッツRV', 'クレソンジャーニー', 'Normal', 'Luxury', 'キャンピング', '8,584,000~10,817,000' , '軽油', 4990 , 2080, 2900 , 3000 ,'AWD', 'これはダミーテキストです。','これはダミーテキストです。'),
...
('40001', ' https://www.honda.co.jp/Fit/webcatalog/design/images/home/img_bodycolor_01.jpg ', 'Honda', 'フィット', 'Normal', 'Celibate', '1,720,400~2,846,800', 'コンパクト',  'ハイブリッド(ガソリン) / ガソリン(レギュラー)','FF', 3995 , 1695, 1540 , 1030 , '高い燃費性能と室内空間を両立するコンパクトカー','これはダミーテキストです'),
('40002', ' https://img1.kakaku.k-img.com/images/productimage/fullscale/K0001459500.jpg ', 'Honda', 'シビックタイプR', 'Normal', 'Celibate', '4,990,000~5,990,000', 'コンパクト',  'ガソリン(ハイオク)','FF', 4595 , 1890, 1405 , 1430 , 'これはダミーテキストです','これはダミーテキストです'),
('40003', ' https://img1.kakaku.k-img.com/images/productimage/fullscale/K0001362084.jpg ', '日産', 'オーラ', 'Normal', 'Celibate', '2,770,000~3,170,000', 'コンパクト',  'ハイブリッド(ガソリン)','FF / 4WD', 4120 , 1735, 1525 , 1420 , 'これはダミーテキストです','これはダミーテキストです'),
('40004', ' https://img1.kakaku.k-img.com/images/productimage/fullscale/K0001253767.jpg ', 'Toyota', 'ヤリスクロス', 'Normal', 'Celibate', '1,790,000~3,150,000', 'コンパクト',  'ハイブリッド(ガソリン)','FF / 4WD', 4200 , 1765, 1590 , 1270 , 'これはダミーテキストです','これはダミーテキストです'),


('50001', ' https://www.honda.co.jp/Nbox/common/images/type/cs_turbo_twotone/c_gray_silver.jpg ', 'Honda', 'N-BOX', 'Normal', 'Celibate', '軽自動車', '1,689,600~2,382,600', 'ガソリン(レギュラー)', 3395 , 1475, 1815 , 1020 ,'FF', '日本一売れている実用性バツグンの軽自動車','これはダミーテキストです。');
('50002', ' https://img1.kakaku.k-img.com/images/productimage/fullscale/K0001221286.jpg ', 'Honda', 'ハスラー', 'Normal', 'Celibate', '軽自動車', '1,510,000~1,970,000', 'ハイブリッド(ガソリン)', 3395 , 1475, 1680 , 860 ,'FF / 4WD', 'これはダミーテキストです','これはダミーテキストです。');
